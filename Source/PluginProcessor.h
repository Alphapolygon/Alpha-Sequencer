...
public:
    ...
    void setTrackScaleNative(int tIdx, int scaleType);
    ...
    void setTrackRandomAmountNative(int pIdx, int tIdx, int paramIdx, float amount);
    void resetAutomationLaneNative(int pIdx, int tIdx, const juce::String& paramName);
    ...
    std::atomic<float> trackRandomAmounts[MiniLAB3Seq::kNumPatterns][MiniLAB3Seq::kNumTracks][6] = {};
